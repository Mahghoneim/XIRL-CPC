...
def cross_shortstick(savename):
  ...
  experiments = [
      Experiment(
          ...
          path="/tmp/xirl/rl_runs/env_name=SweepToTop-Gripper-State-Allo-TestLayout-v0_reward=learned_reward_type=distance_to_goal_mode=same_algo=xirl_uid=518da267-4314-42a6-95e6-69bb57a46bb8/0/",
